...
public class ForeService extends Service {
   ...
   private Notification getNotification(String title, String message) {
      ...
      //创建一个跳转到活动页面的意图
      Intent clickIntent = new Intent(this, MeetingActivity.class);
   ...
   private void createNotificationChannel() {
      NotificationChannel channel = new NotificationChannel("f_channel_id", "CHANNEL_NAME", NotificationManager.IMPORTANCE_MIN);
      //是否绕过请勿打扰模式
